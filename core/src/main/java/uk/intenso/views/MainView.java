...
import uk.intenso.intenginev2.lmlpatch.widgets.LmlSourceHighlighter;
import uk.intenso.intenginev2.lmlpatch.widgets.MockHighlighter;


public class MainView extends AbstractLmlView implements LmlView {
    ...
    public void processUpperCaseAttribute(final NewAttributeLmlMacroTag.AttributeParsingData data) {
